...
//
///////////////////////////////////////////
Shader "Mobile/Particles/Alpha Blended Top Mask Colored" {
Properties {
...
void main()
{
    ...
    u_xlat0.xy = in_TEXCOORD1.xy + (-_UVRange.xy);
    u_xlat4.xy = (-_UVRange.xy) + _UVRange.zw;
    u_xlat0.zw = u_xlat0.xy / u_xlat4.xy;
...
void main()
{
    u_xlat16_0 = texture(_Mask, vs_TEXCOORD1.xy).w;

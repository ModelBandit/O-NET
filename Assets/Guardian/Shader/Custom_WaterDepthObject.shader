...
//
///////////////////////////////////////////
Shader "Custom/WaterDepthObject" {
Properties {
_MainTex ("Texture", 2D) = "white" { }
_Color ("Color", Color) = (1,1,1,1)
_Color2 ("Color2", Color) = (1,1,1,1)
_WaterHeight ("Water Height (물의 높이 (Y값)", Float) = 0
...
void main()
{
    ...
    vs_TEXCOORD1 = hlslcc_mtx4x4unity_ObjectToWorld[3].y * in_POSITION0.w + u_xlat0.y;
...
void main()
{
    u_xlat16_0.x = _WaterHeight / _MaxDepth;
    u_xlat1 = u_xlat16_0.x + (-vs_TEXCOORD1);
    ...
    u_xlat16_0 = vec4(u_xlat1) * u_xlat16_0 + _Color;

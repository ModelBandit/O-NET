...
//
///////////////////////////////////////////
Shader "Custom/Matcap Forward Y Gradation" {
Properties {
...
void main()
{
    ...
    u_xlat1.x = u_xlat1.z + (-_GradStart);
    ...
    u_xlat4.xy = vec2(u_xlat9) * u_xlat4.xy;
    vs_TEXCOORD1.xy = u_xlat4.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    u_xlat9 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat9 = inversesqrt(u_xlat9);
    vs_NORMAL0.xyz = vec3(u_xlat9) * u_xlat0.xyz;
    u_xlat16_2 = (-_GradStart) + _GradEnd;
    u_xlat0.x = u_xlat1.x / u_xlat16_2;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_0.xyz * vec3(3.0, 3.0, 3.0);
    u_xlat16_0 = (-u_xlat16_1) + _GradColor;
    SV_Target0 = vec4(vs_TEXCOORD5) * u_xlat16_0 + u_xlat16_1;
    return;
}
...
void main()
{
    ...
    u_xlat1.yzw = hlslcc_mtx4x4unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat5.xyz;
    u_xlat0.x = (-u_xlat0.x) + u_xlat1.z;
    u_xlat0.x = u_xlat0.x * _Shear;
    u_xlat5.x = u_xlat1.y + (-_WorldSpaceCameraPos.x);
    u_xlat1.x = u_xlat0.x * u_xlat5.x + u_xlat1.y;
    u_xlat0 = u_xlat1.zzzz * hlslcc_mtx4x4unity_MatrixVP[1];
    u_xlat0 = hlslcc_mtx4x4unity_MatrixVP[0] * u_xlat1.xxxx + u_xlat0;
    vs_TEXCOORD2.xyz = u_xlat1.xzw;
    u_xlat0 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat1.wwww + u_xlat0;
    ...
    u_xlat6.xyz = hlslcc_mtx4x4unity_MatrixV[2].xyz * u_xlat0.zzz + u_xlat6.xyz;
    u_xlat6.xyz = hlslcc_mtx4x4unity_MatrixV[3].xyz * u_xlat0.www + u_xlat6.xyz;
    u_xlat15 = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat6.xy = vec2(u_xlat15) * u_xlat6.xy;
    vs_TEXCOORD1.xy = u_xlat6.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    ...
    vs_TEXCOORD4 = hlslcc_mtx4x4unity_WorldToShadow[3] * u_xlat2.wwww + u_xlat3;
    u_xlat15 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat15 = inversesqrt(u_xlat15);
    vs_NORMAL0.xyz = vec3(u_xlat15) * u_xlat0.xyz;
    u_xlat16_4 = (-_GradStart) + _GradEnd;
    u_xlat0.x = u_xlat1.x / u_xlat16_4;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    vs_TEXCOORD5 = u_xlat0.x;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_2.xyz * vec3(3.0, 3.0, 3.0);
    u_xlat16_1 = (-u_xlat16_0) + _GradColor;
    SV_Target0 = vec4(vs_TEXCOORD5) * u_xlat16_1 + u_xlat16_0;
    return;
}
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_0.xyz;
    u_xlat16_1.xyz = (-u_xlat16_3.xyz);
    u_xlat16_1.w = (-u_xlat10_0.w);
    u_xlat16_1 = u_xlat16_1 + _GradColor;
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(vs_TEXCOORD4);
    SV_Target0.w = vs_TEXCOORD4 * u_xlat16_1.w + u_xlat10_0.w;
    SV_Target0.xyz = u_xlat10_0.xyz * u_xlat16_2.xyz + u_xlat16_3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_1 + _GradColor;
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(vs_TEXCOORD4);
    SV_Target0.w = vs_TEXCOORD4 * u_xlat16_1.w + u_xlat16_0.w;
...
void main()
{
    ...
    vs_TEXCOORD2 = hlslcc_mtx4x4unity_WorldToLight[3] * u_xlat0.wwww + u_xlat2;
    u_xlat0.xyz = in_NORMAL0.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].xyz;
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].xyz * in_NORMAL0.xxx + u_xlat0.xyz;
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[2].xyz * in_NORMAL0.zzz + u_xlat0.xyz;
    u_xlat12 = dot(u_xlat0.xyz, u_xlat0.xyz);
    ...
    u_xlat16_3 = (-_GradStart) + _GradEnd;
    u_xlat0.x = u_xlat1.x / u_xlat16_3;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    vs_TEXCOORD4 = u_xlat0.x;
    return;
}
...
void main()
{
    ...
    u_xlat0.x = dot(vs_TEXCOORD2.xyz, vs_TEXCOORD2.xyz);
    u_xlat0.x = texture2D(_LightTextureB0, u_xlat0.xx).x;
    u_xlat4 = textureCube(_LightTexture0, vs_TEXCOORD2.xyz).w;
...
void main()
{
    ...
    u_xlat0.xy = hlslcc_mtx4x4unity_WorldToLight[0].xy * u_xlat0.xx + u_xlat4.xy;

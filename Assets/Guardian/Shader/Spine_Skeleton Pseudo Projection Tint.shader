...
//
///////////////////////////////////////////
Shader "Spine/Skeleton Pseudo Projection Tint" {
Properties {
...
void main()
{
    ...
    u_xlat0.w = u_xlat10_1.w * _TintColor.w;
...
#endif
uniform 	mediump vec4 _TintColor;
UNITY_LOCATION(0) uniform mediump sampler2D _ProjectionTex;
...
void main()
{
    ...
    u_xlat0.w = u_xlat16_1.w * _TintColor.w;

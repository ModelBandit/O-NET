...
//
///////////////////////////////////////////
Shader "Custom/Matcap Forward Circular Gradation" {
Properties {
...
_GradStart ("Gradation Start", Float) = 0
_GradEnd ("Gradation End", Float) = 0
...
void main()
{
    ...
    vs_TEXCOORD1.xy = u_xlat2.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    u_xlat2.xy = u_xlat0.xz + (-_WorldSpaceCameraPos.xz);
    vs_TEXCOORD2.xyz = u_xlat0.xyz;
    u_xlat0.x = dot(u_xlat2.xy, u_xlat2.xy);
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat16_3 = u_xlat0.x + (-_GradStart);
    u_xlat16_7 = (-_GradStart) + _GradEnd;
    u_xlat16_3 = u_xlat16_3 / u_xlat16_7;
    u_xlat16_3 = clamp(u_xlat16_3, 0.0, 1.0);
    vs_TEXCOORD5 = u_xlat16_3;
...
void main()
{
    ...
    u_xlat0 = (-u_xlat16_1) + _GradColor;
    u_xlat0 = vec4(vs_TEXCOORD5) * u_xlat0 + u_xlat16_1;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat1 = (-u_xlat16_0) + _GradColor;
    u_xlat0 = vec4(vs_TEXCOORD5) * u_xlat1 + u_xlat16_0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat16_2 = u_xlat0.x + (-_GradStart);
    u_xlat16_5 = (-_GradStart) + _GradEnd;
...
void main()
{
    ...
    u_xlat1 = u_xlat1 + _GradColor;
    u_xlat1.xyz = u_xlat1.xyz * vec3(vs_TEXCOORD4);
    u_xlat3.w = vs_TEXCOORD4 * u_xlat1.w + u_xlat10_0.w;
    u_xlat3.xyz = u_xlat10_0.xyz * u_xlat16_2.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat3;
    return;
}
...
void main()
{
    ...
    u_xlat1 = u_xlat1 + _GradColor;
    u_xlat1.xyz = u_xlat1.xyz * vec3(vs_TEXCOORD4);
    u_xlat3.w = vs_TEXCOORD4 * u_xlat1.w + u_xlat16_0.w;
    u_xlat3.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat3;
    return;
}
...
void main()
{
    ...
    vs_TEXCOORD2.xy = hlslcc_mtx4x4unity_WorldToLight[3].xy * u_xlat1.ww + u_xlat1.xy;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    u_xlat1.xy = u_xlat0.xz + (-_WorldSpaceCameraPos.xz);
    vs_TEXCOORD1.xyz = u_xlat0.xyz;
    u_xlat0.x = dot(u_xlat1.xy, u_xlat1.xy);

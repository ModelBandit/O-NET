...
//
///////////////////////////////////////////
Shader "MatCap/Detail Bend" {
Properties {
_Color ("Tint Color", Color) = (0.5,0.5,0.5,1)
_MainTex ("Base (RGB)", 2D) = "white" { }
_MatCap ("MatCap (RGB)", 2D) = "white" { }
[Header(Bend)] _BendAmount ("Bend Amount", Vector) = (0,0,0,0)
...
uniform 	vec3 _BendAmount;
uniform 	vec4 _BendOffset;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xyz + (-_BendOffset.xyz);
    u_xlat1.xy = u_xlat0.xz * _BendAmount.xz;
    u_xlat1.x = dot(u_xlat1.xy, u_xlat1.xy);
    u_xlat0.w = u_xlat0.y + (-u_xlat1.x);
    u_xlat0.xyz = u_xlat0.xwz + _BendOffset.xyz;

...
//
///////////////////////////////////////////
Shader "Spine/SkeletonGhost Face" {
Properties {
...
void main()
{
    ...
    u_xlat2 = u_xlat1.xxxx * hlslcc_mtx4x4unity_MatrixVP[0].xwyz;
    u_xlat0.xy = hlslcc_mtx4x4unity_MatrixVP[1].yz * u_xlat0.xx + u_xlat2.zw;
    u_xlat6.xy = hlslcc_mtx4x4unity_MatrixVP[1].xw * u_xlat1.yy + u_xlat2.xy;
    u_xlat6.xy = hlslcc_mtx4x4unity_MatrixVP[2].xw * u_xlat1.zz + u_xlat6.xy;
    gl_Position.xw = hlslcc_mtx4x4unity_MatrixVP[3].xw * u_xlat1.ww + u_xlat6.xy;
    u_xlat0.xy = hlslcc_mtx4x4unity_MatrixVP[2].yz * u_xlat1.zz + u_xlat0.xy;
    gl_Position.yz = hlslcc_mtx4x4unity_MatrixVP[3].yz * u_xlat1.ww + u_xlat0.xy;

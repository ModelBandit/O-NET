...
void main()
{
    ...
    u_xlat16_7 = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_4 + (-u_xlat16_7);
    u_xlat16_10 = _RimSmoothness * 0.5 + _RimSize;
    ...
    u_xlat16_1.xzw = u_xlat16_1.xxx * _RimColor.xyz;
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat16_2.xyz = u_xlat0.xyz * _LightColor0.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(u_xlat16_4) + u_xlat16_1.xzw;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_9 = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_5.x + (-u_xlat16_9);
    u_xlat16_13 = _RimSmoothness * 0.5 + _RimSize;
    ...
    u_xlat16_1 = u_xlat16_1 * _RimIntensity;
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat16_2.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat16_3.xyz = u_xlat0.xyz * vs_TEXCOORD3.xyz;
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat16_5.xxx + u_xlat16_3.xyz;
    SV_Target0.xyz = vec3(u_xlat16_1) * _RimColor.xyz + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.x = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_3 + (-u_xlat16_7.x);
    u_xlat16_11 = _RimSmoothness * 0.5 + _RimSize;
    u_xlat16_7.x = (-u_xlat16_7.x) + u_xlat16_11;
    u_xlat16_7.x = float(1.0) / u_xlat16_7.x;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_7.x;
    u_xlat16_14 = clamp(u_xlat16_14, 0.0, 1.0);
    u_xlat16_7.x = u_xlat16_14 * -2.0 + 3.0;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_14;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_7.x;
    u_xlat16_14 = u_xlat16_14 * _RimIntensity;
    u_xlat16_7.xyz = vec3(u_xlat16_14) * _RimColor.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(u_xlat16_3) + u_xlat16_7.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3 = max(u_xlat16_3, 0.0);
    u_xlat16_7.x = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_13 = u_xlat16_13 * u_xlat16_3 + (-u_xlat16_7.x);
    u_xlat16_11 = _RimSmoothness * 0.5 + _RimSize;
    u_xlat16_7.x = (-u_xlat16_7.x) + u_xlat16_11;
    u_xlat16_7.x = float(1.0) / u_xlat16_7.x;
    u_xlat16_13 = u_xlat16_13 * u_xlat16_7.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_13 = min(max(u_xlat16_13, 0.0), 1.0);
#else
    u_xlat16_13 = clamp(u_xlat16_13, 0.0, 1.0);
#endif
    u_xlat16_7.x = u_xlat16_13 * -2.0 + 3.0;
    u_xlat16_13 = u_xlat16_13 * u_xlat16_13;
    u_xlat16_13 = u_xlat16_13 * u_xlat16_7.x;
    u_xlat16_13 = u_xlat16_13 * _RimIntensity;
    u_xlat16_7.xyz = vec3(u_xlat16_13) * _RimColor.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(u_xlat16_3) + u_xlat16_7.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat0.x = unity_ShadowFadeCenterAndType.w * u_xlat0.x + u_xlat17;
    u_xlat0.x = u_xlat0.x * _LightShadowData.z + _LightShadowData.w;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat17 = texture2D(_ShadowMapTexture, vs_TEXCOORD5.xy).x;
    u_xlatb17 = vs_TEXCOORD5.z<u_xlat17;
    u_xlat17 = u_xlatb17 ? 1.0 : float(0.0);
    u_xlat17 = max(u_xlat17, _LightShadowData.x);
    u_xlat16_16 = (-u_xlat17) + 1.0;
    u_xlat16_16 = u_xlat0.x * u_xlat16_16 + u_xlat17;
    ...
    u_xlat16_9 = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_16 = u_xlat16_4.x * u_xlat16_16 + (-u_xlat16_9);
    u_xlat16_4.x = _RimSmoothness * 0.5 + _RimSize;
    u_xlat16_4.x = (-u_xlat16_9) + u_xlat16_4.x;
    u_xlat16_4.x = float(1.0) / u_xlat16_4.x;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_4.x;
    u_xlat16_16 = clamp(u_xlat16_16, 0.0, 1.0);
    u_xlat16_4.x = u_xlat16_16 * -2.0 + 3.0;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_16;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_4.x;
    u_xlat16_16 = u_xlat16_16 * _RimIntensity;
    SV_Target0.xyz = vec3(u_xlat16_16) * _RimColor.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_16 = u_xlat0.x * u_xlat16_16 + _LightShadowData.x;
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
#endif
    u_xlat16_16 = u_xlat0.x * u_xlat16_3.x + u_xlat16_16;
    ...
    u_xlat16_8 = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_16 = u_xlat16_3.x * u_xlat16_16 + (-u_xlat16_8);
    u_xlat16_3.x = _RimSmoothness * 0.5 + _RimSize;
    ...
    u_xlat16_16 = clamp(u_xlat16_16, 0.0, 1.0);
#endif
    u_xlat16_3.x = u_xlat16_16 * -2.0 + 3.0;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_16;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_3.x;
    u_xlat16_16 = u_xlat16_16 * _RimIntensity;
    SV_Target0.xyz = vec3(u_xlat16_16) * _RimColor.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat9 = inversesqrt(u_xlat9);
    u_xlat0.xyz = vec3(u_xlat9) * u_xlat0.xyz;
    u_xlat16_4 = dot(vs_TEXCOORD1.xyz, u_xlat0.xyz);
    u_xlat16_4 = max(u_xlat16_4, 0.0);
    u_xlat16_7 = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_4 + (-u_xlat16_7);
    u_xlat16_10 = _RimSmoothness * 0.5 + _RimSize;
...
void main()
{
    ...
    u_xlat9 = inversesqrt(u_xlat9);
    u_xlat0.xyz = vec3(u_xlat9) * u_xlat0.xyz;
    u_xlat16_2 = dot(vs_TEXCOORD1.xyz, u_xlat0.xyz);
    u_xlat16_2 = max(u_xlat16_2, 0.0);
    u_xlat16_5.x = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_10 = u_xlat16_10 * u_xlat16_2 + (-u_xlat16_5.x);
    u_xlat16_8 = _RimSmoothness * 0.5 + _RimSize;
    ...
    u_xlat16_10 = u_xlat16_10 * u_xlat16_5.x;
    u_xlat16_10 = u_xlat16_10 * _RimIntensity;
    u_xlat16_5.xyz = vec3(u_xlat16_10) * _RimColor.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(u_xlat16_2) + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat0.xyz;
    u_xlat16_3 = dot(vs_TEXCOORD1.xyz, u_xlat0.xyz);
    u_xlat16_3 = max(u_xlat16_3, 0.0);
    u_xlat16_7.x = (-_RimSmoothness) * 0.5 + _RimSize;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_3 + (-u_xlat16_7.x);
    u_xlat16_11 = _RimSmoothness * 0.5 + _RimSize;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat9 = texture2D(_LightTexture0, vs_TEXCOORD3.xy).w;

...
//
///////////////////////////////////////////
Shader "Mobile/Particles/Alpha Blended Mask Grayscale" {
Properties {
...
void main()
{
    ...
    u_xlat0.x = dot(u_xlat10_0.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat0.xyz = u_xlat0.xxx * vec3(_Brightness);
    SV_Target0.xyz = u_xlat0.xyz;
    u_xlat10_0.x = texture2D(_Mask, vs_TEXCOORD1.xy).w;
    SV_Target0.w = u_xlat10_0.x * u_xlat10_0.w;
    return;
}
...
void main()
{
    ...
    u_xlat0.x = dot(u_xlat16_0.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat0.xyz = u_xlat0.xxx * vec3(_Brightness);
    SV_Target0.xyz = u_xlat0.xyz;
    u_xlat16_0.x = texture(_Mask, vs_TEXCOORD1.xy).w;
    SV_Target0.w = u_xlat16_0.x * u_xlat16_0.w;
    return;
}

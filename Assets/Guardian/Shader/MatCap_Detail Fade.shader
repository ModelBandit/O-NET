...
void main()
{
    u_xlat10_0 = texture2D(_MatCap, vs_TEXCOORD1.xy);
    ...
    u_xlat16_1 = _FadeColor + vec4(-1.0, -1.0, -1.0, -1.0);
    u_xlat16_1 = vec4(_TextureFade) * u_xlat16_1 + vec4(1.0, 1.0, 1.0, 1.0);
...
void main()
{
    u_xlat16_0 = texture(_MatCap, vs_TEXCOORD1.xy);
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = max(u_xlat16_1.xyz, vec3(_TextureFade));
    u_xlat16_1.w = u_xlat16_1.w * _Color.w;
    u_xlat16_1.xyz = u_xlat16_2.xyz * _Color.xyz;
